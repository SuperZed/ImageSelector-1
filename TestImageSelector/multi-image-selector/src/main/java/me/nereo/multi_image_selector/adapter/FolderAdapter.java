...
//                            .into(holder.cover);
                    ...
                    SelectorFinal.getCoreConfig().getImageLoader().displayImage(mContext, f.cover.path,
                            holder.cover, defaultDrawable, mImageSize, mImageSize);
                }
            } else {
...
//                    .into(cover);
            ...
            Drawable defaultDrawable = mContext.getResources().getDrawable(R.drawable.default_error);
            SelectorFinal.getCoreConfig().getImageLoader().displayImage(mContext, data.cover.path, cover, defaultDrawable, mImageSize, mImageSize);
            // TODO 选择标识
        }
    }
